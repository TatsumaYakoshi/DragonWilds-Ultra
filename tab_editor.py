...
def setup_editor_tab(
    ...
    tk.Label(bulk_frame, text="Bulk Set Inventory", font=("Arial", 10, "bold")).grid(row=0, column=0, columnspan=4, sticky="w", pady=(0, 4))
    ...
    def bulk_apply():
        ...
        save_and_refresh()
        update_your_items()
    tk.Button(bulk_frame, text="Apply to Main Slots", command=bulk_apply, width=20).grid(row=2, column=0, columnspan=4, pady=8)
